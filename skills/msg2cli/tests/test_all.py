...
class TestIMessageInput:
    ...
    def test_get_last_message(self):
        ...
        assert msg is not None or msg is None  # 可能有也可能没有消息
        if msg:
    ...
    def test_is_auto_message(self):
        ...
        assert inp.is_auto_message("测试消息", markers) is False
...
class TestIMessageReply:
    ...
    def test_send_summary_format(self):
        ...
        class DummyReply(BaseReply):
            def __init__(self, config): super().__init__(config); self.sent = []
