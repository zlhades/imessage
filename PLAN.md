...
| 任务 | 描述 | 状态 |
|------|------|------|
| 1.1 | 项目初始化 (TypeScript + Node.js 20+) | ⬜ |
| 1.2 | Slack MCP Server 配置 | ⬜ |
| 1.3 | Qwen Code CLI 集成 | ⬜ |
| 1.4 | 本地交互界面 (CLI 输入/输出) | ⬜ |
| 1.5 | 日志系统 (Winston + JSON) | ⬜ |
...
| 任务 | 描述 | 状态 |
|------|------|------|
| 2.1 | AI Provider 抽象层定义 | ⬜ |
| 2.2 | Qwen Provider 实现 (DashScope API) | ⬜ |
| 2.3 | 意图识别模块 | ⬜ |
| 2.4 | 信息完整性检查器 | ⬜ |
| 2.5 | 追问逻辑实现 | ⬜ |
| 2.6 | Claude Provider 占位实现 | ⬜ |
...
| 任务 | 描述 | 状态 |
|------|------|------|
| 3.1 | GitHub MCP 集成 (查代码/提交/PR) | ⬜ |
| 3.2 | 日志 MCP 集成 (查错误日志) | ⬜ |
| 3.3 | Prometheus MCP 集成 (查指标) | ⬜ |
| 3.4 | 调查结果汇总模块 | ⬜ |
...
|------|------|------|
| 4.1 | 第一次 Pull → 生成回复草稿 | ⬜ |
| 4.2 | 本地确认界面 (Confirm/Modify/Investigate) | ⬜ |
| 4.3 | 发送前第二次 Pull 检查 | ⬜ |
| 4.4 | 新消息影响判断逻辑 | ⬜ |
| 4.5 | 本地信息补充功能 | ⬜ |
...
| 任务 | 描述 | 状态 |
|------|------|------|
| 6.1 | 配置文件支持多 Provider | ⬜ |
| 6.2 | Provider Router 实现 | ⬜ |
| 6.3 | 迁移文档编写 | ⬜ |
